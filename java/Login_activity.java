...
public class LoginActivity extends AppCompatActivity {
 ...
 if (task.isSuccessful()) {
   Toast.makeText(LoginActivity.this, "We have sent you instructions to reset your password!", 
...
Toast.LENGTH_SHORT).show();
 ...
 processDialog.show();
 auth.signInWithEmailAndPassword(userEmail, userPassword).addOnCompleteListener(new 
